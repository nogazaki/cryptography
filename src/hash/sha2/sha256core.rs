use super::{DigestUser, HasherCore, SHA224_DIGEST_SIZE_BIT, SHA256_DIGEST_SIZE_BIT};
use crate::utils::{
    self,
...
const DIGEST_SIZE_BIT: usize = 256;
...
#[inline(always)]
fn small_sig_0(x: u32) -> u32 {
    x.rotate_right(7) ^ x.rotate_right(18) ^ x.shr(3)
}
#[inline(always)]
fn small_sig_1(x: u32) -> u32 {
