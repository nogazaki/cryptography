...
/// let result = Sha224::new().chain_update("").finalize();
/// assert_eq!(result, hash);
///
/// ```
pub type Sha224 = Hasher<sha256core::Sha256Core, SHA224_DIGEST_SIZE_BIT>;
...
/// let result = Sha256::new().chain_update("").finalize();
/// assert_eq!(result, hash);
///
/// ```
pub type Sha256 = Hasher<sha256core::Sha256Core, SHA256_DIGEST_SIZE_BIT>;
...
/// let result = Sha384::new().chain_update("").finalize();
/// assert_eq!(result, hash);
///
/// ```
pub type Sha384 = Hasher<sha512core::Sha512Core, SHA384_DIGEST_SIZE_BIT>;
...
/// let result = Sha512::new().chain_update("").finalize();
/// assert_eq!(result, hash);
///
/// ```
pub type Sha512 = Hasher<sha512core::Sha512Core, SHA512_DIGEST_SIZE_BIT>;
...
/// let result = Sha512_224::new().chain_update("").finalize();
/// assert_eq!(result, hash);
///
/// ```
pub type Sha512_224 = Hasher<sha512core::Sha512Core, SHA224_DIGEST_SIZE_BIT>;
...
/// let result = Sha512_256::new().chain_update("").finalize();
/// assert_eq!(result, hash);
///
/// ```
pub type Sha512_256 = Hasher<sha512core::Sha512Core, SHA256_DIGEST_SIZE_BIT>;
